...
var msg3 = "Klik op een van de icoontjes om naar de download pagina te gaan.";
...
function ieWarning() {
    var imgPath = "/beheer/resources/images/";
...
document.body.clientHeight ) ) {
    ...
    _hd.style.paddingLeft = "0px";
    _hd.style.color = "#333";
    _hd.style.background = "#fff";
